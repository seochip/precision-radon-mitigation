      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-accent/10 border-l-4 border-accent p-8 rounded-lg max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground mb-4">
            Every home is different, and there's no one-size-fits-all solution for radon mitigation. After testing your home, we design a custom system based on your foundation type, soil conditions, and radon levels. Our installations use locally manufactured fans and American-made materials, ensuring long-lasting performance.
          </p>
          <p className="text-muted-foreground">
            <strong className="text-foreground">All our systems meet or exceed EPA and ANSI/AARST standards,</strong> and we provide documentation and post-mitigation testing to verify effectiveness.
          </p>
        </div>
      </div>
    </section>
